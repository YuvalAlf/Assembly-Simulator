...
type ParsedCommand =
    ...
    static member ParseCommand (tokens : TokenType list) : Option<ParsedCommand * TokenType list> =
        ...
        | OpBRn::(Label label)::rest   -> Some(OpCodeCommand(BranchOperation(true, false, false, Choice1Of2 label)), rest)
        | OpBRz::(Label label)::rest   -> Some(OpCodeCommand(BranchOperation(false, true, false, Choice1Of2 label)), rest)
        | OpBRp::(Label label)::rest   -> Some(OpCodeCommand(BranchOperation(false, false, true, Choice1Of2 label)), rest)
        | OpBRnz::(Label label)::rest  -> Some(OpCodeCommand(BranchOperation(true, true, false, Choice1Of2 label)), rest)
        | OpBRnp::(Label label)::rest  -> Some(OpCodeCommand(BranchOperation(true, false, true, Choice1Of2 label)), rest)
        | OpBRzp::(Label label)::rest  -> Some(OpCodeCommand(BranchOperation(false, true, true, Choice1Of2 label)), rest)
        | OpBRnzp::(Label label)::rest -> Some(OpCodeCommand(BranchOperation(true, true, true, Choice1Of2 label)), rest)
        | OpBRn::(Number num)::rest   -> Some(OpCodeCommand(BranchOperation(true, false, false, Choice2Of2 num)), rest)
        | OpBRz::(Number num)::rest   -> Some(OpCodeCommand(BranchOperation(false, true, false, Choice2Of2 num)), rest)
        | OpBRp::(Number num)::rest   -> Some(OpCodeCommand(BranchOperation(false, false, true, Choice2Of2 num)), rest)
        | OpBRnz::(Number num)::rest  -> Some(OpCodeCommand(BranchOperation(true, true, false, Choice2Of2 num)), rest)
        | OpBRnp::(Number num)::rest  -> Some(OpCodeCommand(BranchOperation(true, false, true, Choice2Of2 num)), rest)
        | OpBRzp::(Number num)::rest  -> Some(OpCodeCommand(BranchOperation(false, true, true, Choice2Of2 num)), rest)
        | OpBRnzp::(Number num)::rest -> Some(OpCodeCommand(BranchOperation(true, true, true, Choice2Of2 num)), rest)
